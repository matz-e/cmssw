...
namespace l1t {
   namespace stage2 {
      class RegionalMuonEMTFUnpacker : public Unpacker {
         public:
...
namespace l1t {
   namespace stage2 {
      bool
      RegionalMuonEMTFUnpacker::unpack(const Block& block, UnpackerCollections *coll)
      {

	// Appears to be specific to GMT - AWB 11.01.16
...
DEFINE_L1T_UNPACKER(l1t::stage2::RegionalMuonEMTFUnpacker);
