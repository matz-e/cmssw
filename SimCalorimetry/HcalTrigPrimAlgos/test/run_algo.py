...
process.simHcalTriggerPrimitiveDigis.inputLabel = cms.VInputTag(cms.InputTag("simHcalUnsuppressedDigis","HBHEUpgradeDigiCollection","DIGI2RAW"), cms.InputTag("simHcalUnsuppressedDigis","HFUpgradeDigiCollection","DIGI2RAW"))
