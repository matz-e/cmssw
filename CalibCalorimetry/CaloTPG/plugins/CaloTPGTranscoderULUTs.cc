...
CaloTPGTranscoderULUTs::produce(const CaloTPGRecord& iRecord)
{
   ...
   return std::auto_ptr<CaloTPGTranscoderULUT>(new CaloTPGTranscoderULUT(file1, file2, fullLut, *theTrigTowerGeometry, NCTScaleShift, RCTScaleShift, lsbQIE8, lsbQIE11, linearLUTs_));
}
